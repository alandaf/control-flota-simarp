...
| GET | `/alerts` | Alertas operativas en vivo (GPS sin señal, solicitud sin conductor, recogida demorada, viaje prolongado, desvío) |
| GET | `/audit` | Bitácora de auditoría de acciones de administración (`limit` opcional) |
